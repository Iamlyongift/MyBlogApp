...
exports.sendOtp = exports.verifyOtpController = exports.forgotPasswordController = exports.loginUser = exports.RegisterUser = void 0;
...
const verifyOtpController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield (0, auth_service_1.verifyOtp)(email, otp);
        return res.status(result.status).json({
...
const sendOtp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email } = req.body;
    try {
        const result = yield (0, auth_service_1.requestOtp)(email);
        res.status(200).json(result);
    }
    catch (error) {
